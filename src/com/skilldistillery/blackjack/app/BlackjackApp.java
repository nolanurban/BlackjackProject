...
public class BlackjackApp {
	...
	public void run() {
		...
		ourDealer.addCard(ourDeck.dealCard());
		System.out.println("Dealer shows: " + ourDealer.getVisibleCard().toString());
		...
		if (ourPlayer.isBust()) {
			...
			System.out.println("Dealer had: " + ourDealer.toString());
			return;
		}
		// now dealer begins play, dealer cards are all now visible to user
		System.out.println("Dealer begins play");
